...
document.addEventListener( 'wpcf7mailsent', function( event ) {
    location = 'https://completemarquees.co.uk/success';
}, false );
</script>
...
<body <?php body_class(); ?>><?php //hobbes_phone_number(''); ?>
  <!-- Google Tag Manager (noscript) -->
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WNL7C2N"  height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
...
<header>
  ...
  --><div class="contact__info">
      <span class="header__text">make your event extra special</span>
       ...
       <div class="telephone__number"><span class="callustoday">Call Us Today</span> <a href="tel:01428751745">01428 751 745</a></div>
      
      
      
      <a href="mailto:completemarquee@gmail.com" class="email">Email: completemarquee@gmail.com</a>
    </div>
  </div>
</header>
...
<div id="navigation">
  <div class="container--large">
    <div id="mobile__menu">
      ...
      --><a class="fixednumber rulertel" href="tel:01428751745">01428 751 745</a>
    </div>
    <div id="desktop__nav">
      <?php wp_nav_menu( array( 'theme_location' => 'header-menu' ) ); ?>
    </div>
    <div id="mobile__nav">
      <div class="mobile__nav__close"><i class="fa fa-times" aria-hidden="true"></i></div>
      <?php wp_nav_menu( array( 'theme_location' => 'header-menu' ) ); ?>
    </div>
  </div>
</div>
